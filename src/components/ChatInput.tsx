      ...
      <div className="flex items-center gap-3">
        ...
        <div className={`flex-1 relative ${isAutoActive ? 'auto-mode-glow' : ''}`}>
            <textarea
              ...
              disabled={disabled}
              rows={1}
              className={`w-full min-h-[48px] max-h-[200px] py-3 px-4 pr-12 rounded-3xl border focus:outline-none text-sm resize-none overflow-y-auto transition-all ${
                isDragging 
                  ? 'border-nova-pink bg-nova-pink/5 ring-2 ring-nova-pink/20' 
                  : !isAutoActive 
